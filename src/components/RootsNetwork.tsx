...
const paths = [
  "M200 20 C200 90 120 110 90 180 C70 230 78 290 70 340",
  "M200 20 C200 100 170 140 160 200 C150 260 158 310 155 355",
  "M200 20 C200 100 230 140 245 205 C258 262 252 310 255 355",
  "M200 20 C200 90 285 110 315 180 C338 232 332 292 340 340",
];
